...
| GET    | `/admin`                       | Cloudflare Access | Admin page with five tabs: Images (file explorer) + Editor (写作台) + AI playground + Stats (analytics dashboard) + Comments (moderation); UI is English-only |
